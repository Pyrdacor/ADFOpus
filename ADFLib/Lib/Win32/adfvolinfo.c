/*! \file	adfvolinfo.c
 *  \brief	Windows version of adfVolumeInfo().
 *
 ...
 *	\return	Void.
 *
 *	Receives a handle to the window on which to display the dialogue and a pointer to an ADFLib Volume structure.
 *	Displays a Windows dialogue containing the disk file data.
 */
{
