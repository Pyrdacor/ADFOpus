/*! \file	Win32/adf_nativ.c
 *  \brief	Win32 specific drive-access routines for ADFLib.
 *
 ...
 *
 *	\b Typical Usage \n
 *	See <A HREF="../../api_native.html">api_native.html</A> for an example of typical usage of the native functions
 *	and how to add platform support to ADFLib.
 */
